package com.example.vietschool;
...
import com.example.vietschool.chatAI.MainChat;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intenChatAI = new Intent(MainActivity.this, MainChat.class);
                startActivity(intenChatAI);
            }
        });
